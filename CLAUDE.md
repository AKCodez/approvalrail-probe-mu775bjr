...
This repository was generated by IdeaWave Clone Studio for the product "Approvalrail". SPEC.md is the product specification, BRAND.md is the brand identity every surface has to keep, BUILD_ORDER.md shows what is done, and TODO.md lists the remaining work in order. Keep the conventions above; run `npm run verify` before finishing any task.
