...
import { GearIcon, SparkleIcon, SquaresFourIcon, TrayIcon } from "@phosphor-icons/react/dist/ssr";
...
const NAV: readonly NavItem[] = [
  ...
  },
  {
    href: "/queue",
    label: "Queue",
    icon: <TrayIcon aria-hidden="true" weight="regular" className="size-4 shrink-0" />,
  },
  {
    href: "/repurpose",
    label: "Repurpose",
    icon: <SparkleIcon aria-hidden="true" weight="regular" className="size-4 shrink-0" />,
  },
  {
    href: "/settings",
    label: "Settings",
