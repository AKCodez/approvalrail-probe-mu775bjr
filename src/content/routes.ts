...
export const publicRoutes: readonly PublicRoute[] = [
  ...
  { path: "/review", label: "Review link", priority: 0.7, changeFrequency: "daily", inNav: true },
  {
    path: "/content-repurposing-tool-for-agencies",
    label: "For agencies",
    priority: 0.7,
    changeFrequency: "monthly",
    inNav: false,
  },
  { path: "/compare", label: "Compare", priority: 0.6, changeFrequency: "weekly", inNav: false },
  {
    path: "/compare/postpeer",
    label: "Compare",
    priority: 0.8,
